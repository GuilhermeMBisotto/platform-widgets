...
class PlatformApp extends StatefulWidget {
  ...
  @override
  _PlatformAppState createState() => _PlatformAppState(createIosApp: (context) => createIosApp(context), createAndroidApp: (context) => createAndroidApp(context));
}

class _PlatformAppState<I, A> extends State<PlatformApp> {

  _PlatformAppState({@required this.createIosApp, @required this.createAndroidApp});
